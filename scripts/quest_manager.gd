...
func _ready():
	...
	quest_checkers = {
		...
		"StartEndMinLat": {"func": _check_coordinate_spread, "expected": true, "args": ["lat", "start_end", 15.0, "min"]},
		"StartEndMinLon": {"func": _check_coordinate_spread, "expected": true, "args": ["lon", "start_end", 20.0, "min"]},
